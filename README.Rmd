...
- **interactive Scatterplot:**  `easyPlot` features an interactive scatterplot where users can seamlessly identify outliers, calculate simple summary statistics for marked points, and efficiently zoom into specific areas of the graph. This functionality enhances the utility of the scatterplot for various data exploration purposes.
...
Live version of the app can be accessed [here](http://easyplot.michalmajka.com).
